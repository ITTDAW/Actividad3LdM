    ...
    <html lang="en">
      ...
      <body>
        ...
        <div class="ciclos">
          ...
          <!-- dentro de un contenedor ciclos vamos a separar el titular que irá dentro de una etiqueta para incluir una imagen de fondo que haga la página más visual y posteriormente la tabla con los ciclos-->

          <picture>

          <h2 class="tittle">CICLOS GRADO SUPERIOR</h2>
          </picture>
            ...
            <xsl:for-each select="ite/ciclos/ciclo">
              <tr>
                ...
                <td>
                  <a>
                    <xsl:attribute name="href">
                      <xsl:value-of select="nombre/@info" />
                    </xsl:attribute>
        ...
        <!-- ##################################### PARTE DEL PERSONAL ############################################-->
        <!-- Hacemos un bloque comun para todo el personal -->
          ...
          <div class ="admin">
            <ul class="lista1">
              ...
              <li>
                ...
                <a>
                 <xsl:attribute name="href">
                   <xsl:value-of select="ite/personal/administracion/director/nombre/@link" />
                 </xsl:attribute>
                 <!-- Para abrir el enlace en otra pagina diferente se utiliza la siguiente linea -->
                 <xsl:attribute name="target">_blank</xsl:attribute>
                 <xsl:value-of select="ite/personal/administracion/director/nombre" />
               </a>
                 
                 <br/>
                 <xsl:value-of select="ite/personal/administracion/director/despacho" />
               ...
               <li>
                ...
                <a>
                  <xsl:attribute name="href">
                    <xsl:value-of select="ite/personal/administracion/jefe_estudios/nombre/@link" />
                  </xsl:attribute>
                  <!-- Para abrir el enlace en otra pagina diferente se utiliza la siguiente linea -->
                  <xsl:attribute name="target">_blank</xsl:attribute>
                  <xsl:value-of select="ite/personal/administracion/jefe_estudios/nombre" />
                </a>
              <br/>
              <xsl:value-of select="ite/personal/administracion/jefe_estudios/despacho" />
              </li>
              ...
              <h3>DOCENCIA</h3>
                  ...
                  <xsl:for-each select="ite/personal/docencia/profesor">
                    ...
                    <li>
                      ...
                      <a>
                        <xsl:attribute name="href">
                          <xsl:value-of select="nombre/@link" />
                        </xsl:attribute>
                        <!-- Para abrir el enlace en otra pagina diferente se utiliza la siguiente linea -->
                        <xsl:attribute name="target">_blank</xsl:attribute>
                        <xsl:value-of select="nombre" />
                      </a>
                      <p><xsl:value-of select="modulos" /></p>
                    </li>
